  ...
  const handleFileUpload = async (event) => {
    ...
    try {
      ...
      if (uploadType === 'revenue') {
        ...
        // Extract month from CSV content
        ...
        setData(newData)
        setUploadedData({ ...uploadedData, [month]: { ...uploadedData[month], expenses: true } })
            ...
            <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
              ...
              <div className="mb-4">
                <p className="text-gray-600 mb-4">
                  ...
                  {uploadType === 'expenses' && 'Upload an Excel (.xlsx) file with Zoho Books Profit and Loss data. The month will be automatically extracted from the file content.'}
                  {uploadType === 'payroll' && 'Upload payroll data (functionality coming soon).'}
                </p>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                  ...
                  >
                    ...
                    <span className="text-sm text-gray-600">
                      ...
                      {uploadType === 'payroll' && 'Select Payroll File'}
                    </span>
                  </label>
                </div>
